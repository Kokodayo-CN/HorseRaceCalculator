...
## How to use it?  
Simply head to "Release" and download the zip file from the latest release. You can then run the Calculator directly in the uncompressed folder. No installation required, and no Internet connection required. Do not tamper the .manifest file in the umcompressed folder for optimal result.  
